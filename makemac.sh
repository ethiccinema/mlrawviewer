...
cp README macdmg/
hdiutil create -srcfolder "macdmg" -volname "MlRawViewer 1.4.1" -fs HFS+ -fsargs "-c c=64,a=16,e=16" -format UDRW -size 50000k mlrawviewer.temp.dmg
hdiutil convert "mlrawviewer.temp.dmg" -format UDZO -imagekey zlib-level=9 -o "MlRawViewer_1_4_1_mac"
